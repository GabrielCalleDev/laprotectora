        ...
        <h1 class="text-4xl text-center font-poppinsBlack py-4">¡Adopta no compres!</h1>
            ...
            <form action="{{ route('adoptions.search') }}" method="get">
                <div class="flex justify-around items-center">
                    <div>
                        <label class="block text-center" for="select-specie" class="">Mascota</label>
                    ...
                    <div>
                        <label class="block text-center" for="input-select" class="">Edad</label>
                    ...
                    <div>
                        <label class="block text-center" for="input-select" class="">Sexo</label>
                    ...
                    <div>
                        <label class="block text-center" for="input-select" class="">Tamaño</label>
                    ...
                    <div>
                        <button  class="mt-2 p-3 rounded-lg bg-green-500" type="submit"><i class="fa fa-search" aria-hidden="true"></i> Buscar</button>
                    </div>
                </div>
