<div>
    @if ($showForm)
        ...
        <form wire:submit.prevent="submit" class="max-w-3xl bg-white mx-auto border-2 border-gray-500 rounded-3xl p-4 md:p-8">
            ...
            <div class="mb-6">
                <label for="subject" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Asunto de tu contacto</label>
                <input type="text"  wire:model.defer="subject" id="subject" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Asunto" >
            </div>
            <div class="mb-6">
            ...
            <div class="w-60 mx-auto">
                <span wire:click="submit" class="cursor-pointer group relative inline-block text-sm font-medium text-white focus:outline-none focus:ring">
                    ...
                    <span class="block border border-blue-600 bg-blue-600 px-12 py-3 transition-transform active:border-blue-500 active:bg-blue-500 group-hover:translate-x-1 group-hover:translate-y-1">
    ...
    @else
        <div class="max-w-3xl bg-white mx-auto border-2 border-gray-500 rounded-3xl p-4 md:p-8">
            <img src="{{ Vite::asset('resources/img/template/logo.png') }}" alt="" class="mx-auto w-40 bg-white rounded-lg">
            <h1 class="text-xl text-center font-poppinsBlack py-4">Gestión realizada correctamente</h1>
            <p class="text-center p-6 bg-green-300 rounded border-2 border-green-500">Gracias por contactar con nosotros, en breve nos pondremos en contacto contigo.</p>
        </div>
    @endif
