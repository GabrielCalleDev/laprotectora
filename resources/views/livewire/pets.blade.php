<div>
    <section class="container mx-auto py-4 px-4 md:px-8 bg-gray-100 rounded-3xl mt-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 text-center gap-8 p-6 md:p-0 mt-4">
            ...
            @forelse ($pets as $pet)
                ...
                <a href="{{ route('pet.show', $pet) }}" class="hover:opacity-80 transition duration-300 ease-in-out">
        ...
        <div>
            <a href="{{ route('adoptions') }}" class="max-w-md mx-auto flex justify-center items-center bg-secondary text-white font-poppinsBlack text-xl mt-8 mb-6 py-2 rounded-2xl hover:bg-secondaryHover transition duration-300 ease-in-out">
                {{ __('Ver más') }}
